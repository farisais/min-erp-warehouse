...
function CreateData()
{
    load_content_ajax(GetCurrentController(), 177, null, null);
}
...
function EditData()
{
    ...
    if(row != null)
    {
        ...
        load_content_ajax(GetCurrentController(), 178 ,data_post, param);
    }
    else
    {
       ...
       if(confirm("Are you sure you want to delete notification_setting : " + row.name))
        {
            var data_post = {};
            data_post['id_notification_setting'] = row.id_notification_setting;
            load_content_ajax(GetCurrentController(), 179 ,data_post);
        }
    }
    else
    {
