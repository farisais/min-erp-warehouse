...
$(document).ready(function(){  
    ...
    $("#post").click(function(){
        ...
        {?>
            ...
            param.push(item);        
            load_content_ajax(GetCurrentController(), 124, data_input, param);
        <?php 
        }
        else
        {?>
            ...
            load_content_ajax(GetCurrentController(), 123, data_input);
        <?php
        }
        ?>
    });
    ...
    $("#unpost").click(function(){
        ...
        {?>
            ...
            item['paramValue'] = <?php echo $data_edit[0]['id_stock_transaction'] ?>;
            param.push(item);        
            load_content_ajax(GetCurrentController(), 125, data_input, param);
        <?php 
        }
        ?>
    });
