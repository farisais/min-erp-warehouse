...
$(document).ready(function(){  
    ...
    $("#supplier-name").jqxInput({ source: dataAdapterSupplier, displayMember: "name", valueMember: "id_supplier", height: 23<?php if(isset($is_view)){ echo ',disabled: true';} ?>});
    ...
    $("#select-mr-grid").jqxGrid(
    {
        ...
        columns: [
            ...
            { text: 'Project list', dataField: 'project_list_number'},
    ...
    $('#select-mr-grid').on('rowdoubleclick', function (event) 
    {
        ...
        var url = "<?php echo base_url()?>mr/get_mr_product_open_po?id=" + data.id_mr;
        var source =
        {
            datatype: "json",
            datafields:
    ...
    $("#receive-payment").click(function(){
        var data_post = {};
        data_post['id_po'] = $("#id_po").val();
        load_content_ajax('warehouse', 101, data_post);
    });
