...
class Invoice extends MY_Controller
{
    ...
    {
        $this->invoice_model->change_invoice_status($this->input->post('id_invoice'), 'void');
    }
    ...
    public function view_invoice_detail($id)
    {
        $data = array(
            "so" => $this->so_model->get_so_all(),
            "bank" => $this->bank_model->get_bank_all(),
    ...
    public function make_invoice($id)
    {
        ...
        return array("interfunction_param" => $interfunction_param);
        $this->so_model->change_so_status($data['id_so'], 'deliver');
    }
